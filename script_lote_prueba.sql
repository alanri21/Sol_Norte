...
--------------------------------------------------------------------------------
-- Caso 1: INSERT VALIDO
-- Descripcion: socio con datos correctos
...
-- Debe aparecer el socio 'Juan Perez' y 'Alan Riquelme'
GO
--------------------------------------------------------------------------------
-- Caso 2: INSERT INVALIDO
-- Descripcion: socio menor, sin un socio responsable
...
-- Descripcion: modifico al socio camila
...
-- Descripcion: intento eliminar al socio Alan (responsable de otro)
...
-- Esperado: registro de Alan todavia existe
GO
--------------------------------------------------------------------------------
-- Caso 6: DELETE VALIDO
-- Descripcion: elimino al socio Camila (menor con responsable)
